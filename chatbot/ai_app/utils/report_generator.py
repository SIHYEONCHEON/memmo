...
import os
import json
from ai_app.utils.function_calling import FunctionCalling, func_specs_report
...
user_input=input()
steps = create_step_plan(template.format(과제=user_input))
response_message = ""
for step in steps.values():
    print("step:", step)
    print()
    user_message = f"{step}:\n{response_message}"
    analyzed_dict = func_calling.analyze_function(user_message, func_specs_report)
